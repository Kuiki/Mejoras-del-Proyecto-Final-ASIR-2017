...
?>
	<div id='entrada'>
	<div style='float: right; margin: 5px 10px 0px 0px;'><img  src='../pdf.png'><a href="../imprimir.php?id=<?php echo $_GET['id'];?>"><span style='position: relative;bottom: 15px;'>Imprimir</span></a><br><br>
	</div>
<?php
